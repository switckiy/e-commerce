...
-- Database: `ci4_login`
--
CREATE DATABASE IF NOT EXISTS `ci4_login` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `ci4_login`;
...
INSERT INTO `shop` (`id`, `name`, `images`, `quantity`, `price`, `deskripsi`) VALUES
(22, 'Nestlé DANCOW 3+ Madu Susu Anak 3-5 Tahun Box 1Kg', '1686017940_09dd961df0c417390188.webp', 200, 101.602, 'DANCOW Parenting Center adalah mitra andalan para orang tua untuk tumbuh kembang si Kecil. Bunda dapat memperoleh berbagai tips dan info seputar parenting. Kini DANCOW Parenting Center mempersembahkan StimuLearn Program edukatif untuk orang tua membantu anak belajar dan bereksplorasi bersama.'),
(23, 'Nestlé NANKID 3 pHPro Plain Susu Anak 1-3 Tahun Kaleng 800g', '1686018474_858027828468db2055ce.jpg', 200, 334.500, '- Protein whey terhidrolisis parsial / sebagian (50%). Protein merupakan salah satu komponen esensial dalam pertumbuhan dan perkembangan anak, yang bermanfaat membangun dan memperbaiki jaringan tubuh. - 12 vitamin dan 9 mineral - Minyak ikan - Omega 6 / Asam linoleat - Kalsium membantu dalam pembentukan dan mempertahankan kepadatan tulang dan gigi'),
(24, 'TOLAK ANGIN madu box 12 sachet', '1686019038_15b43a08fcb9f93cebca.webp', 200, 40.500, 'Tolak angin merupakan sediaan herbal untuk mengatasi masuk angin, seperti:pusing, meriang, kembung, sakit perut, tengorokan kering, mual dan muntah, serta meningkatkan daya tahan tubuh. Tolak angin cair juga dapat diminum saat perjalanan jauh, kecapaian dan kurang tidur.');
